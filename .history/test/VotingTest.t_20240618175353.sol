...
contract VotingTest is Test{
    ...
    function test_CreateContestantSuccesfully() public {
        ...
        vm.startPrank(address(USER1));
        voting.createContestant(1, "Contestant 1", "Contestant 1 Description", "Contestant 1 Image");
        Voting.Contestant memory contestant = voting.getContestant(1, 1);
        vm.stopPrank();

        assertEq(contestant.name, "Contestant 1");
        assertEq(contestant.description, "Contestant 1 Description");
        assertEq(contestant.image, "Contestant 1 Image");
