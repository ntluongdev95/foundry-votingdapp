...
contract EIP712Test is Test {
    ...
    function test_GetSignerEIP712() public view {
        Voting.VotingMessage memory voteMsg = Voting.VotingMessage({
            poolId: 1,
            contestantId: 1,
            tickNumber: 12345,
        ...
        // Construct the signature from r, s, and v
        bytes memory signature = abi.encodePacked(r, s, v);
        // assertEq(signature,0x69d00d06fa6dd520612acc67b714fc75ba755f89fe402ab37ac678367f2c3cde5b84d35f63cde12ea9722b4ddef67185ced6eb2b85ea3d0ea7f56679837cd8131c);
    
        // Recover the signer address
        address recoveredAddress = voting.getSignerEIP712(voteMsg, signature);
        assertEq(recoveredAddress, address(user_1), "Recovered address does not match the signer");
        assertEq(signature,0x69d00d06fa6dd520612acc67b714fc75ba755f89fe402ab37ac678367f2c3cde5b84d35f63cde12ea9722b4ddef67185ced6eb2b85ea3d0ea7f56679837cd8131c,"Signature mismatch");
    }
