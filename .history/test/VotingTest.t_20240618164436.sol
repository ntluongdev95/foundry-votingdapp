...
contract VotingTest is Test{
    ...
    function testUpdatePoolSuccessfully() public {
        string[] memory newImages = new string[](2);
        newImages[0] = "newImage1.jpg";
        newImages[1] = "newImage2.jpg";
        string memory newName = "Updated Pool";
        uint256 newStartAt = block.timestamp + 4800;
        uint256 newEndsAt = block.timestamp + 10800;
